...
@section('page-title', 'Crea nuova sala')
...
@section('content')
    <div class="container mt-4" style="max-width:1000px;">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
            <h1 class="h4 mb-0">Crea nuova sala</h1>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('admin.rooms.store') }}" method="POST" class="row g-3">
                    @csrf
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="number" id="max_clients" name="max_clients"
                            ...
                            max="100" step="1" required inputmode="numeric" value="{{ old('max_clients') }}">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control form-control-sm @error('description') is-invalid @enderror" id="description"
                            name="description" rows="4" placeholder="Opzionale...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
