...
@section('page-title', 'Modifica macchina')
...
@section('content')
    <div class="container mt-4" style="max-width:1000px;">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
            <h1 class="h4 mb-0">Modifica macchina: {{ $machine->name }}</h1>
            <div class="d-flex gap-2">
                <a href="{{ route('machines.show', $machine) }}" class="btn btn-sm btn-secondary">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('admin.machines.update', $machine) }}" method="POST" class="row g-3">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="form-control form-control-sm @error('description') is-invalid @enderror" placeholder="Opzionale...">{{ old('description', $machine->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
