...
@section('page-title', 'Crea nuovo pacchetto')

@section('content')
    <div class="container mt-4" style="max-width:800px;">
        {{-- Header + azioni --}}
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
            <h1 class="h4 mb-0">Crea nuovo pacchetto</h1>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('admin.packages.store') }}" method="POST" class="row g-3">
                    @csrf
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2 mt-2">
                        <a href="{{ route('packages.index') }}" class="btn btn-sm btn-outline-secondary">Annulla</a>
